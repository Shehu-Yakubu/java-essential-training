...
public class ReusableCods {
    public static void main(String[] args) {
        Scanner sc = new Scanner(System.in);
        var i1 = getInput(sc, "Enter a numeric value 1: ");
        var i2 = getInput(sc, "Enter a numeric value 2: ");

        double result = addValues(i1, i2);
        System.out.println("The sum is " + result);

        double resultOfFour = addValues(i1, i2, i1, i2);
        System.out.println("The answer is " + resultOfFour);
